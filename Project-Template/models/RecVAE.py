...
class RecVAE(nn.Module):
    def __init__(self, margs):
        ...
        self.latent_dim = margs.latent_dim
        ...
        self.beta = margs.beta
        self.gamma = margs.gamma
        self.dropout_rate = margs.dropout_rate
    ...
    def forward(self, user_ratings, calculate_loss=True):
